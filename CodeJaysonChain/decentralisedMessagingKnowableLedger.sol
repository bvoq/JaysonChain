...
contract DirectMessagingKnowableLedger {
    //DM Features:
    ...
    //DMKL Features:
    //This version adds one ledger to every account. Here all the read messages can be transferred into your own ledger.
